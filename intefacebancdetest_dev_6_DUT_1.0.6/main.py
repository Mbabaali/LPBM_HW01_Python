...
################################################################################################
        ...
        self.cptalarmeon6 = Label(text="66", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.917, 'center_y':0.05})
        self.add_widget(self.cptalarmeon6)
        self.cptalarmeoff6 = Label(text="666", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.980, 'center_y':0.05})
        ...
        if(passerelle.start_stop == 1):
            ...
            if((statut=='0') and (passerelle.flag_seuil==True)):
                ...
                if(A5_mA>alarm_sleep_mA):
                    ...
                    print(";".join([date, str(A5_mA), "mA", "Sleep"]), file=out555)
                    Logger.warning("écriture dans le ficheir ")
                ...
                if(A6_mA>alarm_sleep_mA):
                    ...
                    print(";".join([date, str(A6_mA), "mA", "Sleep"]), file=out666)
                    Logger.warning("écriture dans le ficheir ")
            ...
            if(statut=='1'):
                ...
                if(A5_mA>alarm_awake_mA):
                    ...
                    print(";".join([date, str(A5_mA), "mA", "Awake"]), file=out555)
                ...
                if(A6_mA>alarm_awake_mA):
                    ...
                    print(";".join([date, str(A6_mA), "mA", "Awake"]), file=out666)
...
if __name__ == "__main__":
    ...
    try:
        arduino1 = serial.Serial(port='/dev/ttyACM0',baudrate=115200,timeout = 10)
