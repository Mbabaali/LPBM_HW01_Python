        ...
        if(passerelle.start_stop == 1):
            ...
            if arduino1.inWaiting()>0:
                ...
                if(inbox.count(':')!=19):
                    ...
                    statut,passerelle.dut[0].U,passerelle.dut[0].W,passerelle.dut[0].A,passerelle.dut[1].U,passerelle.dut[1].W,passerelle.dut[1].A, passerelle.dut[2].U,passerelle.dut[2].W,passerelle.dut[2].A,passerelle.dut[3].U,passerelle.dut[3].W,passerelle.dut[3].A,passerelle.dut[4].U,passerelle.dut[4].W,passerelle.dut[4].A, passerelle.dut[5].U,passerelle.dut[5].W,passerelle.dut[5].A  = inbox.split(":")
