...
################################################################################################
        ...
        self.cptalarmeon1 = Label(text="11", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.25, 'center_y':0.52})
        self.add_widget(self.cptalarmeon1)
        self.cptalarmeoff1 = Label(text="111", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.305, 'center_y':0.52})
        ...
        self.cptalarmeon3 = Label(text="33", font_size='20sp', size=(100, 50),  pos_hint={'center_x': 0.917, 'center_y':0.52})
        self.add_widget(self.cptalarmeon3)
        self.cptalarmeoff3 = Label(text="333", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.980, 'center_y':0.52})
        ...
        # Alarme Channel 5
        self.alarmeon4 = Label(text="4.4A", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.585, 'center_y':0.15})
        self.add_widget(self.alarmeon4)
        self.alarmeoff4 = Label(text="444uA", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.640, 'center_y':0.15})
        self.add_widget(self.alarmeoff4)
        
        #Label compteur alarme Channel 5
        self.cptalarmeon4 = Label(text="44", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.585, 'center_y':0.05})
        self.add_widget(self.cptalarmeon4)
        self.cptalarmeoff4 = Label(text="444", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.640, 'center_y':0.05})
        self.add_widget(self.cptalarmeoff4)

        # Alarme Channel 6
        self.alarmeon4 = Label(text="4.4A", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.917, 'center_y':0.15})
        self.add_widget(self.alarmeon4)
        self.alarmeoff4 = Label(text="444uA", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.980, 'center_y':0.15})
        self.add_widget(self.alarmeoff4)
        
        #Label compteur alarme Channel 6
        self.cptalarmeon4 = Label(text="44", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.917, 'center_y':0.05})
        self.add_widget(self.cptalarmeon4)
        self.cptalarmeoff4 = Label(text="444", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.980, 'center_y':0.05})
        self.add_widget(self.cptalarmeoff4)
        ...
        self.maxAOn4 = Label(text="0.4A", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.39, 'center_y':0.15})
        self.add_widget(self.maxAOn4)
        self.maxWOn4 = Label(text="4W", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.39, 'center_y':0.05})
        self.add_widget(self.maxWOn4)
        self.maxAoff4 = Label(text="4mA", font_size='20sp', size=(100, 50),  pos_hint={'center_x': 0.5, 'center_y':0.15})
        self.add_widget(self.maxAoff4)
        self.maxWoff4 = Label(text="4mW", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.5, 'center_y':0.05})
        self.add_widget(self.maxWoff4)

        #Label value max channel 6
        self.maxAOn4 = Label(text="0.4A", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.73, 'center_y':0.15})
        self.add_widget(self.maxAOn4)
        self.maxWOn4 = Label(text="4W", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.73, 'center_y':0.05})
        self.add_widget(self.maxWOn4)
        self.maxAoff4 = Label(text="4mA", font_size='20sp', size=(100, 50),  pos_hint={'center_x': 0.84, 'center_y':0.15})
        self.add_widget(self.maxAoff4)
        self.maxWoff4 = Label(text="4mW", font_size='20sp', size=(100, 50), pos_hint={'center_x': 0.84, 'center_y':0.05})
        self.add_widget(self.maxWoff4)
        ...
        if(passerelle.start_stop == 1):
            ...
            if((statut=='0') and (passerelle.flag_seuil==True)):
                if (A1_mA>alarm_sleep_mA):
                    ...
                    print(";".join([date, str(A1_mA), "mA", "Sleep"]), file=out5)
                ...
                if(A2_mA>alarm_sleep_mA):
                    ...
                    print(";".join([date, str(A2_mA), "mA", "Sleep"]), file=out6)
                ...
                if(A3_mA>alarm_sleep_mA):
                    ...
                    print(";".join([date, str(A3_mA), "mA", "Sleep"]), file=out7)
                ...
                if(A4_mA>alarm_sleep_mA):
                    ...
                    print(";".join([date, str(A4_mA), "mA", "Sleep"]), file=out8)
            ...
            if(statut=='1'):
                ...
                if(A1_mA>alarm_awake_mA):
                    ...
                    print(";".join([date, str(A1_mA), "mA", "Awake"]), file=out5)
                ...
                if(A2_mA>alarm_awake_mA):
                    ...
                    print(";".join([date, str(A2_mA), "mA", "Awake"]), file=out6)
                ...
                if(A3_mA>alarm_awake_mA):
                    ...
                    print(";".join([date, str(A3_mA), "mA", "Awake"]), file=out7)
                ...
                if(A4_mA>alarm_awake_mA):
                    ...
                    print(";".join([date, str(A4_mA), "mA", "Awake"]), file=out8)
